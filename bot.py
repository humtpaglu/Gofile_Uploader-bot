...
# ===== WOODcraft ==== SudoR2spr ====
API_ID = int(os.getenv("API_ID" "23897874"))
API_HASH = os.getenv("API_HASH" "ec91dd01da9693911a6ee4af5d0bef2c")
BOT_TOKEN = os.getenv("BOT_TOKEN" "7275898574:AAFdSHor5KPhhefKJE62JYTvyur9CE1YHaM")
...
async def handle_file(client, message):
    ...
    try:
        ...
        await status.edit(
            ...
            "🚀 Powered by @Max_Leech_Zone_Update",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("📥 Download Now", url=link)],
                [InlineKeyboardButton("📢 Updates Channel", url="https://t.me/Max_Leech_Zone_Update")]
            ])
        )
    except Exception as e:
...
async def back_to_start(client, callback_query):
    image_url = "https://envs.sh/L6s.jpg"
    caption = (
        "**Welcome to GoFile Uploader Bot!**\n\n"
        "Just send me any file (video, audio, or document) and I'll upload it to GoFile.\n\n"
        "⚡ Max file size: 4GB\n"
